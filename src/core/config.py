...
class Settings(BaseSettings):
    ...
    service_bus_connection_string: str | None = Field(
        default=None, alias="SERVICE_BUS_CONNECTION_STRING"
    )
    ...
    appinsights_connection_string: str | None = Field(
        default=None, alias="APPINSIGHTS_CONNECTION_STRING"
    )
    ...
    approval_allowed_bill_to_names: str = Field(
        "", alias="APPROVAL_ALLOWED_BILL_TO_NAMES"
    )  # Comma-separated list (empty = accept all)
